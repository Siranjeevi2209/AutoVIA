...
//   Presenting both with matching numbers = strong evidence.
// ═══════════════════════════════════════════════════════════════════
...
function useAnalytics(){
  ...
  const track=useCallback((event,meta={})=>{
    ...
    // Fire and forget — send to backend, don't block UI
    fetch("/api/analytics",{
      method:"POST",
    ...
    setAnalytics(prev=>{
      ...
      switch(event){
        case"session_start":next.total_sessions=(next.total_sessions||0)+1;break;
