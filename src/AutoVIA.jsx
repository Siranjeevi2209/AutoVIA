...
const CPE_RULES = [
  [/\bqnx\b/i,"adas"],[/\bvxworks\b/i,"powertrain"],[/\bautosar\b/i,"powertrain"],[/\bfreertos\b/i,"gateway"],
  [/\bzephyr\b/i,"body"],[/\bthreadx\b/i,"telematics"],[/android[\s-]?auto/i,"infotainment"],
  [/\bopenssl\b/i,"gateway"],[/\bwolfssl\b/i,"telematics"],[/\bmbed ?tls\b/i,"telematics"],
  [/\blinux kernel\b/i,"gateway"],[/\bcan[\s-]?bus\b|\bsocketcan\b|\bj1939\b/i,"gateway"],[/\bflexray\b/i,"chassis"],
  [/\bdoip\b|unified diagnostic/i,"diagnostics"],[/\bsome\/ip\b|\bsomeip\b/i,"adas"],[/\bobd(?:-?ii)?\b/i,"diagnostics"],
  [/\bbluetooth\b|\bble\b/i,"infotainment"],[/\bwi-?fi\b/i,"infotainment"],[/\bv2x\b|\bdsrc\b/i,"telematics"],
  [/\bcellular\b|\b5g\b|\blte\b/i,"telematics"],[/\bota\b|over[\s-]the[\s-]air/i,"telematics"],
  [/\blidar\b/i,"adas"],[/\bmobileye\b|nvidia drive/i,"adas"],[/\bbosch\b/i,"braking"],
  [/\bcontinental\b/i,"chassis"],[/\bdenso\b/i,"powertrain"],[/\bharman\b/i,"infotainment"],
  [/\bnxp\b/i,"gateway"],[/\binfineon\b/i,"powertrain"],[/\brenesas\b/i,"powertrain"],
  [/\bbrake\b|\bbraking\b|\babs\b|\besc\b/i,"braking"],[/\bsteering\b|\beps\b/i,"steering"],
  [/\bairbag\b|\bsrs\b/i,"chassis"],[/\bengine control\b|\becm\b/i,"powertrain"],
  [/\bbattery management\b|\bbms\b/i,"powertrain"],[/\bdoor lock\b|\bkeyless\b|\bkey fob\b/i,"body"],
  [/\bgateway ecu\b/i,"gateway"],[/\btelematics control\b|\btcu\b/i,"telematics"],
  [/\binfotainment\b|\bivi\b|\bhead unit\b/i,"infotainment"],
  [/\btoyota\b|\btesla\b|\bbmw\b|\bmercedes\b|\bvolkswagen\b|\bford\b|\bhyundai\b|\bhonda\b|\bnissan\b|\bkia\b|\bvolvo\b/i,"gateway"],
  [/\bgeotab\b|\bfleet\b/i,"telematics"],[/\bev charg|electric vehicle charg/i,"powertrain"],[/\btpms\b|\btire pressure\b/i,"body"],
];
